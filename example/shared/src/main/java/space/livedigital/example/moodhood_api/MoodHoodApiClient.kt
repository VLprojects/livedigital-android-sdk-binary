...
/**
 * @param additionalInterceptors extra OkHttp interceptors a sample may want to attach
 *  (e.g. the Calls sample attaches a Chucker interceptor for debug inspection). The
 *  shared module intentionally has no opinion about them so it stays dependency-light.
 */
