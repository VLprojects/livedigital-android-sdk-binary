...
class CallConnectionService : ConnectionService() {
    ...
    override fun onCreateIncomingConnection(
        ...
        val call =
            Call(id = id, caller = caller, roomAlias = roomAlias, callerNumber = request.address.schemeSpecificPart)
        val connection = CallConnection(applicationContext, call)
//        connection.connectionProperties = Connection.PROPERTY _SELF_MANAGED
