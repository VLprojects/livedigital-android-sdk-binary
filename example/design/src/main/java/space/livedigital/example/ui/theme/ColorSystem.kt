...
data class ColorSystem(
    ...
    val errorBase: Color,
    val error01: Color,
    val audioPickerContainer: Color,
...
val LocalColorSystem = staticCompositionLocalOf {
    ColorSystem(
        ...
        audioPickerContainer = Color.Unspecified,
        audioPickerSelectedContainer = Color.Unspecified
    )
}
...
val DefaultColorSystem = ColorSystem(
    ...
    audioPickerContainer = Color(0x80252525),
    audioPickerSelectedContainer = Color(0xFFE9EEFD)
)
