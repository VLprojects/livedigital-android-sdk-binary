...
Для релиза приложения в GooglePlay будет требоваться добавить ForegroundService типа microphone|phoneCall, который будет начинаться и кончатся вместе с звонком.
